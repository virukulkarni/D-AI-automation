...
public class Users_PhoneDevice_Modify_Test extends BaseClass {
	...
	public void BasicProvisioningAddUserandDevicefromGUI(
			...
			String strDeviceSearch, String strUserName, String strdeviceName, String strDeviceType,String strTemplate, String strMACAddress, String strTemplateN
		...
		String strTestCaseName = "Users Phone Device Modify test case";
	...
	//Enter Line/ Port
		...
		//	ptr.wait(2000);
			...
			WebElement Dname = driver.findElement(By.xpath("(//span[contains(.,'TestAuto')])[2]"));
			//Step 27. Click on Device Name
			ptr.click(Dname, "Clicking on Device Name");
			ptr.wait(4000);
			
			//Step 28. Change template name from drop down
			ptr.selectDropdownByValue(ProvisioningPages.template, strTemplateN,
					"Selecting the template : " + strTemplateN);
