...
public class Users_PhoneDevice_View_Test extends BaseClass {
	...
	public void BasicProvisioningAddUserandDevicefromGUI(
			...
			String strDeviceSearch, String strUserName, String strdeviceName, String strDeviceType,String strTemplate, String strMACAddress
		...
		String strTestCaseName = "Users Phone Device View test case";
		...
		//	ptr.wait(2000);
			...
			//Setup part :
			//Step 25. Edit User
			//span[contains(.,'AutomationAccountID')]
			driver.findElement(By.xpath("(//span[contains(.,'Automation')])[1]")).click();
		...
		//	ptr.click(OpeasyCommonPageElements.btn_OK, "Clicking on btn OK");
			...
			//Step 27. Click on View button
			ptr.click(ProvisioningPages.Device_viewTemplate, "Clicking on View button");
			
			//Step 28. User Phone Template page is displayed
			clearspanCommon.verifyScreenTitleProvPage("User: Phone Template");
						
			//Step 30. Click on btn OK
			ptr.click(OpeasyCommonPageElements.btn_OK, "Clicking on btn OK");
			
			//Step 30. Click on btn OK
			ptr.click(OpeasyCommonPageElements.btn_Cancel, "Clicking on btn Cancel");
			ptr.wait(2000);
		...
		//	ptr.click(OpeasyCommonPageElements.btn_OK, "Clicking on btn OK");
			...
			ptr.updateStep("Users Phone Device View test case ","Pass");
